package com.example.CrickScoreAppBackend.services.impl;

import com.example.CrickScoreAppBackend.entities.Match;
import com.example.CrickScoreAppBackend.repositories.MatchRepo;
...
public class MatchServiceImpl implements MatchService {
    ...
    //Get the match history of all the matches present in out database
    @Override
    ...
    public List<Match> getLiveMatches() {
        ...
        try {
            ...
            for (Element match : liveScoreElements) {
                ...
                match1.setBattingTeamName(battingTeam);
                match1.setBattingTeamScore(score);
                match1.setBowlingTeamName(bowlTeam);
                match1.setBowlingTeamScore(bowlTeamScore);
                match1.setLiveText(textLive);
                match1.setMatchLink(matchLink);
                match1.setMatchCompletedText(textComplete);
...
//                update the match in database
    ...
    @Override
    public List<List<String>> getIPL2023PointTable() {
        System.out.println("Started the function");
